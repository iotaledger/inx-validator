...
require (
	...
	github.com/iotaledger/hive.go/logger v0.0.0-20231110120127-f90b276b7c05 // indirect
	...
	github.com/iotaledger/iota.go/v4 v4.0.0-20231110131407-263d0662856b // indirect
